 ...
 ***********************************************************************/
 ...
 $request_config = array('IdType' => 'ISBN',
 						'IdList' => array('9780836218664', '9780836218787'));
 $request = new MarketplaceWebServiceProducts_Model_GetMatchingProductForIdRequest($request_config);
